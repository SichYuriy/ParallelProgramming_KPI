...
int main(){
	...
	HANDLE task1_handle, task2_handle, task3_handle;

	task1_handle = CreateThread(0, 0, task1, 0, 0, 0);
	task2_handle = CreateThread(0, 0, task2, 0, 0, 0);
	task3_handle = CreateThread(0, 0, task3, 0, 0, 0);

	WaitForSingleObject(task1_handle, INFINITE);
	WaitForSingleObject(task2_handle, INFINITE);
	WaitForSingleObject(task3_handle, INFINITE);
